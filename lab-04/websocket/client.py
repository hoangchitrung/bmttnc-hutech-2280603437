...
class WebSocketClient:
    ...
    def on_message(self, message):
        ...
        # Tiếp tục đọc tin nhắn tiếp theo
        # Lưu ý: Trong một số phiên bản Tornado mới, việc đọc có thể tự động,
        # nhưng code này giữ nguyên theo bài lab của bạn để đảm bảo tương thích.
        if self.connection:
