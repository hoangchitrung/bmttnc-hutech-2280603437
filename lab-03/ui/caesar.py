...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(40, 120, 67, 22))
        self.label_2.setObjectName("label_2")
        self.txt_key = QtWidgets.QLineEdit(self.centralwidget)
        self.txt_key.setGeometry(QtCore.QRect(130, 230, 521, 41))
        self.txt_key.setStyleSheet("QLineEdit {\n"
"    border: 1px solid black;\n"
"}")
        self.txt_key.setObjectName("txt_key")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(40, 240, 67, 22))
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(30, 350, 81, 22))
        self.label_4.setObjectName("label_4")
        self.encrypt_button = QtWidgets.QPushButton(self.centralwidget)
        self.encrypt_button.setGeometry(QtCore.QRect(160, 460, 100, 38))
        self.encrypt_button.setObjectName("encrypt_button")
        self.decrypt_button = QtWidgets.QPushButton(self.centralwidget)
        self.decrypt_button.setGeometry(QtCore.QRect(450, 460, 100, 38))
        self.decrypt_button.setObjectName("decrypt_button")
        self.txt_plain_text = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_plain_text.setGeometry(QtCore.QRect(130, 90, 521, 83))
...
"")
        ...
        self.txt_cipher_text.setGeometry(QtCore.QRect(130, 330, 521, 83))
